...
BitStreamHost::BitStreamHost(size_t resized_width, size_t resized_height, PixelFormat format)
    : resized_width(resized_width), resized_height(resized_height), format(format) {
